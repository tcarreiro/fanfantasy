  ...
  <div class="main-fader" responsive-height-comments>
    <div class="loader">
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
          viewBox="0 0 462.646 462.646" xml:space="preserve">
        <g>
          <path fill="#000" class="contorno" d="M350.008,105.105c-20.73-37.376-50.944-70.379-87.375-95.442v0c-18.728-12.884-43.892-12.884-62.619,0
          ...
          <path fill="#fff" class="upper_strip" d="M154.555,70.823h153.535c4.657,5.505,9.083,11.174,13.248,17H141.307C145.472,81.997,149.898,76.328,154.555,70.823z" />
          <path fill="#2e1313" class="upper_tip" d="M208.515,22.021c6.821-4.692,14.814-7.039,22.808-7.039s15.986,2.347,22.808,7.039c0,0,0,0,0,0
              c14.559,10.016,28.051,21.376,40.276,33.802H168.24C180.465,43.397,193.957,32.036,208.515,22.021z" />
          <path fill="#fff" class="lower_strip" d="M308.091,391.823H154.555
              c-4.657-5.505-9.083-11.174-13.248-17h180.031C317.174,380.649,312.748,386.318,308.091,391.823z" />
          <path fill="#2e1313" class="lower_tip" d="M254.132,440.625
              c-13.643,9.385-31.974,9.386-45.616,0c-14.559-10.016-28.051-21.376-40.276-33.802h126.167
              C282.182,419.249,268.69,430.609,254.132,440.625z" />
          <path fill="#2e1313" class="fundo" d="M336.89,350.265c-1.789,3.225-3.678,6.403-5.614,9.558H131.37
          ...
          <path fill="#fff" class="costura" d="M255.323,174.823c4.143,0,7.5-3.358,7.5-7.5s-3.357-7.5-7.5-7.5h-16.5v-32.5c0-4.142-3.357-7.5-7.5-7.5s-7.5,3.358-7.5,7.5
